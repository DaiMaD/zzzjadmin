...
//提现管理 - 收益明细 
export let goldCoinLogDetail = (page, pagesize) => {
  return get(`/admin/goldCoinLogDetail?page=${page}&pagesize=${pagesize}`)
}

//提现管理 - 收益明细 
export let goldCoinLogDetailByMobile = (mobile, page, pagesize) => {
  return get(`/admin/goldCoinLogDetailByMobile?mobile=${mobile}&page=${page}&pagesize=${pagesize}`)
}
