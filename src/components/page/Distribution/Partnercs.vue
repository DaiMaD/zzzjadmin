	...
	<div class="table">
		<div>
			...
			<div v-show="boolean1">
				<div class="container">
					<div class="handle-box">
						<el-input size="medium" v-model="zdmobile" placeholder="请输入手机号" class="handle-select mr10" clearable>
						</el-input>
						...
						<el-table :data="list" border style="width: 100%" stripe
							...
							<el-table-column prop="contract_start_time" label="合约生效时间" :formatter="formatTime"
							...
							<el-table-column prop="create_time" label="创建时间" width="200" :formatter="formatTime"
								:show-overflow-tooltip="true"></el-table-column>
							<el-table-column prop="update_time" label="修改时间" width="200" :formatter="formatTime"
								:show-overflow-tooltip="true"></el-table-column>
				...
				<div class="container">
					<div class="handle-box">
						<el-form label-position="left" style="width: 100%">
							<el-input size="medium" v-model="mobilehhr" placeholder="请输入合伙人手机号" class="handle-select mr10" clearable>
							</el-input>
							<el-input size="medium" v-model="mobilezdl" placeholder="请输入总代理手机号" class="handle-select mr10" clearable>
							</el-input>
						...
						<!-- 内容展示 -->
						<el-table :data="list1" border style="width: 100%" stripe
							:header-cell-style="{color:'#000',font_weight:800,background:'#ccc'}">
			...
			<div v-if="boolean2" class="pagination">
				<el-pagination @current-change="handleCurrentChange2" layout="total, prev, pager, next" :total="this.total1">
				</el-pagination>
			</div>
			<!-- -------分页------------- -->
			<div v-else class="pagination">
				<el-pagination @current-change="handleCurrentChange1" layout="total, prev, pager, next" :total="this.total">
				</el-pagination>
			</div>
			<!--新增弹框 总代理-->
						...
						<el-form :model="addForm" :rules="addFormRules" label-position="left" label-width="120px">
							...
							<el-form-item inline label="合约生效时间:" prop="contract_start_time" class="inline-block">
								<div class="inline-block">
									...
									<el-date-picker v-model="addForm.contract_start_time" type="date" placeholder="选择日期"
										format="yyyy 年 MM 月 dd 日" value-format="timestamp"></el-date-picker>
								</div>
							</el-form-item>
							<el-form-item label="签约期限:" prop="contract_year">
								<el-input size="medium" v-model="addForm.contract_year" placeholder="请输入签约期限" class="handle-select mr10"
									clearable></el-input>
							</el-form-item>
						</el-form>
					</div>
					...
					<div class="categories-news-content">
						<el-form :model="addForm1" :rules="addFormRules1" label-position="left" label-width="120px">
							...
							<el-form-item inline label="合约生效时间:" prop="contract_start_time" class="inline-block">
								<div class="inline-block">
									<span class="demonstration"></span>
									<el-date-picker v-model="addForm1.contract_start_time" type="date" placeholder="选择日期"
										format="yyyy 年 MM 月 dd 日" value-format="timestamp"></el-date-picker>
								</div>
							</el-form-item>
							<el-form-item label="签约期限:" prop="contract_year">
			...
			<el-dialog title="收货地址" :visible.sync="dialogFormVisible">
				<el-table :data="gridData" border style="width: 100%" :max-height="400"
