      ...
      <div class="tagsWrap">
        <el-collapse v-model="activeName" accordion>
          <el-collapse-item title="" name="*">
            <template slot="title">
              <h4>● 版本更新：V 0.4.0</h4>
              <span class="updateTime">更新时间：2019-07-09</span>
            </template>
            <p>1.新增页面路由权限功能；在系统管理管理员列表2中可自定义角色或在当前拥有角色下创建账号，然后给我指定角色下账号设置权限，在账号登录时，只能获取到拥有权限的页面</p>
            <p>2.新增路由管理页面可对当前路由进行增删查改，新增一级路由点击外部“新增一级路由”按钮，新增二级三级路由点击其父级路由右侧的"新增子路由"按钮创建</p>
          </el-collapse-item>
