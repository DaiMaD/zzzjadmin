            ...
            <div class="container">
                <div class="handle-box">
                    <!-- <el-select placeholder="支付状态" v-model="orderstatus" :on-change="fenye()">
                        <el-option v-for="item in ddtypeOptions" :key="item.value" :label="item.label"
                    ...
                    <el-tabs type="border-card" v-model="selectType">
                        <el-tab-pane label="全部" name="all">
                            <el-table :data="list" :row-style="tableRowStyle"
                                :header-cell-style="{color:'#000',font_weight:800,background:'#ccc'}" stripe border
                                max-height="680" style="width: 95%;margin-top: 20px;">
                                <el-table-column type="selection" width="55"></el-table-column>
                                <el-table-column prop="coursename" label="课程名称" :show-overflow-tooltip="true">
                                </el-table-column>
                                <!-- <el-table-column prop="order_num" label="订单编号"></el-table-column> -->
                                <el-table-column prop="pay" label="支付价格" :show-overflow-tooltip="true">
                                </el-table-column>
                                ...
                                <el-table-column prop="name" label="用户昵称" :show-overflow-tooltip="true">
                                </el-table-column>
                                <el-table-column prop="mobile" label="用户(手机号)" :show-overflow-tooltip="true">
                                </el-table-column>
                                <el-table-column prop="zongdainame" label="总代理" :show-overflow-tooltip="true">
                                </el-table-column>
                                <el-table-column prop="zongdaimobile" label="对应总代理（手机号）" :show-overflow-tooltip="true">
                                </el-table-column>
                                <el-table-column prop="citypartnername" label="城市合伙人" :show-overflow-tooltip="true">
                                </el-table-column>
                                <el-table-column prop="citypartnermobile" label="对应城市合伙人（手机号）"
                                    :show-overflow-tooltip="true">
                                </el-table-column>
                        ...
                        <el-tab-pane label="已支付" name="payed">
                            <el-table :data="list2" :row-style="tableRowStyle"
                                :header-cell-style="{color:'#000',font_weight:800,background:'#ccc'}" stripe border
                                max-height="680" style="width: 95%;margin-top: 20px;">
                                <el-table-column type="selection" width="55"></el-table-column>
                                <el-table-column prop="coursename" label="课程名称" :show-overflow-tooltip="true">
                        ...
                        <el-tab-pane label="未支付" name="nopay">
                            <el-table :data="list3" :row-style="tableRowStyle"
                                :header-cell-style="{color:'#000',font_weight:800,background:'#ccc'}" stripe border
                                max-height="680" style="width: 95%;margin-top: 20px;">
                                <el-table-column type="selection" width="55"></el-table-column>
                                <el-table-column prop="coursename" label="课程名称" :show-overflow-tooltip="true">
                            ...
                            <div class="pagination">
                                <el-pagination background @size-change="handleSizeChange"
                                    @current-change="handleCurrentChange" :page-sizes="[10, 20, 30, 40]" :page-size="10"
                                    layout="total, sizes, prev, pager, next, jumper" :total="this.total3">
                                </el-pagination>
                            </div>
                        </el-tab-pane>
                        <el-tab-pane label="已取消" name="yiquxiao">
                            <el-table :data="list4" :row-style="tableRowStyle"
                                :header-cell-style="{color:'#000',font_weight:800,background:'#ccc'}" stripe border
                                max-height="680" style="width: 95%;margin-top: 20px;">
                                <el-table-column type="selection" width="55"></el-table-column>
                                <el-table-column prop="coursename" label="课程名称" :show-overflow-tooltip="true">
                            ...
                            <div class="pagination">
                                <el-pagination background @size-change="handleSizeChange"
                                    @current-change="handleCurrentChange" :page-sizes="[10, 20, 30, 40]" :page-size="10"
                                    layout="total, sizes, prev, pager, next, jumper" :total="this.total4">
                                </el-pagination>
                            </div>
                        </el-tab-pane>
                    </el-tabs>
