						...
						<el-form :model="addForm" :rules="addFormRules" ref="addForm" label-position="left" label-width="80px">
							...
							<el-form-item inline label="举办时间:" prop="time" class="inline-block">
								<div class="inline-block">
									...
									<el-date-picker v-model="addForm.time" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日"
							...
							<el-form-item inline label="截止时间:" prop="expire_time" class="inline-block">
								<div class="inline-block">
									<span class="demonstration"></span>
									<el-date-picker v-model="addForm.expire_time" type="date" placeholder="选择日期"
										:picker-options="pickerOptions" format="yyyy 年 MM 月 dd 日" value-format="timestamp">
									</el-date-picker>
								</div>
							</el-form-item>
			...
			<div class="categories-news" v-if="this.editShow">
				<div class="categories-news-main categories-content-main">
					<div class="categories-news-title">
						...
						<i class="iconfont icon-msnui-close-fat" @click="cancelEditing"></i>
						<el-upload class="avatar-uploader uploader-none" :show-file-list="false" action=""
							:on-change="handleTextImageSuccess" :auto-upload="false" :on-success="uploadSuccess"
