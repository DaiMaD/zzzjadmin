          ...
          <div class="categories-news-content">
            <el-form :model="addForm" :rules="addFormRules" ref="addForm" label-position="left" label-width="80px">
              ...
              <el-form-item inline label="截止时间:" prop="update_time" class="inline-block">
                <div class="inline-block">
                  <span class="demonstration"></span>
                  <el-date-picker v-model="addForm.update_time" type="date" placeholder="选择日期">
                  </el-date-picker>
                </div>
              </el-form-item>
              ...
              <el-form-item label="缩略图:" prop="avatar">
                ...
                <el-upload class="upload-demo" :show-file-list="false" action="" :on-change="handleAvatarSuccess"
                  :auto-upload="false">
              ...
              <el-form-item label="头图:" prop="banner">
                ...
                <el-upload class="upload-demo" :show-file-list="false" action="" :on-change="handleBannerSuccess"
                  :auto-upload="false">
                  <el-button slot="trigger" size="small" type="primary">选取文件</el-button>
                </el-upload>
              </el-form-item>
