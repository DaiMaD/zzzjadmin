  ...
  <div class="table">
    <div class="container">
      ...
      <el-table :data="list" border max-height="680" style="width: 100%" ref="multipleTable"
        ...
        <el-table-column prop="head_img" label="头图" min-width="150">
        ...
        <el-table-column prop="course_brief" label="课程要点" min-width="100"><template slot-scope="scope">
            <span @click="kechengyaodianhaibao(scope.$index, scope.row)" style="cursor: pointer">点击查看详情</span>
          </template></el-table-column>
        <!--<el-table-column prop="course_brief_linkshare" label="课程要点(链接)" min-width="300"><template slot-scope="scope">
            <span @click="kechengyaodianlianjie(scope.$index, scope.row)" style="cursor: pointer">点击查看详情</span>
          </template></el-table-column>-->
        <!--<el-table-column prop="syllabus" label="课程大纲" min-width="300"><template slot-scope="scope">
            <span @click="kechengdagang(scope.$index, scope.row)" style="cursor: pointer">点击查看详情</span>
          </template></el-table-column>
        <el-table-column prop="suitabe_population" label="适宜人群" min-width="300"><template slot-scope="scope">
            <span @click="shiyirenqun(scope.$index, scope.row)" style="cursor: pointer">点击查看详情</span>
          </template></el-table-column>-->
        <!--<el-table-column prop="purchase_notice" label="购买须知"  min-width="300"><template slot-scope="scope">
          ...
          <div class="categories-news-content">
            <el-form :model="addForm" :rules="addFormRules" ref="addForm" label-position="left" label-width="80px">
              ...
              <!--<el-form-item label="课程要点(链接):" prop="course_brief_linkshare">
                <el-input type="textarea" autosize placeholder="请输入内容" v-model="addForm.course_brief_linkshare"></el-input>
              </el-form-item>
...
<script>
  ...
  import { getfmshare, posteradd, posterupdate, getPicURL, DeletePoster } from '../../../../api/api';
  ...
  export default {
    ...
    methods: {
      ...
      async getData() {
        await getfmshare(this.cur_page, this.size, this.parentid).then(res => {
          console.log(res)
