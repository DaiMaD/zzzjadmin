<template>
    <div class="table">
        <!-- 控制器 -->
        <DIV id="pushtype">
          推送类型:&nbsp;&nbsp;&nbsp;  <el-radio v-model="pushtype" label="1">消息推送</el-radio>  <el-radio v-model="pushtype" label="2">课程推送</el-radio> <el-radio v-model="pushtype" label="3">版本更新</el-radio>      
        </DIV>
        <!-- 消息推送 -->
            ...
            <div class="categories-news-content">
              <el-form  :model="addForm" label-position="left" label-width="100px">
                ...
                <el-form-item label="标题文案:" prop="pushtitle" :rules="[
                  ...
                  <el-input v-model="addForm.pushtitle" class="handle-input" placeholder="至多50个字" :change="xzzf()"></el-input>
                ...
                <el-form-item label="发送时间:">
                  <el-radio v-model="radio2" label="1" class="countetps">立即发送</el-radio>  <el-radio v-model="radio2" label="2" class="countetps">自定义时间:</el-radio>  
                     <el-date-picker class="countetps"
                      v-model="pushtime"
                      type="datetime"
                      placeholder="选择日期时间">
                    </el-date-picker>
          ...
          <div class="categories-news-main">
            <div class="categories-news-content">
              <el-form  :model="addForm" label-position="left" label-width="100px">
                ...
                <el-radio v-model="addForm.target" label="1" class="countetps">商学院</el-radio> <el-radio v-model="addForm.target" label="2" class="countetps">大讲堂</el-radio> <el-radio v-model="addForm.target" label="3" class="countetps">FM:</el-radio>  <div class="block">
                 <el-select v-model="targettype1" style='width:100px'  class="countetps mar">
                  <el-option
                    v-for="item in gifOptions"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value">
                  </el-option>
                </el-select>
                </div>    <el-radio v-model="addForm.target" label="4"  class="countetps" >今日速递:</el-radio> 
                ...
                <el-radio v-model="addForm.target" label="5" class="countetps">活动</el-radio><el-radio v-model="addForm.target" label="6" class="countetps">读书</el-radio> <el-radio v-model="addForm.target" label="7" class="countetps">Banner</el-radio>
                </el-form-item>
                ...
                <el-form-item label="当前选择的ID：">
                  <el-input size="medium"  v-model="addForm.targetid" placeholder="选择的id" class="handle-select mr10" clearable>
                </el-input>
                </el-form-item>
                <el-form-item label="目标人群:">
                  <el-radio v-model="radio1" label="1" class="countetps">全部用户</el-radio>  
            ...
            <div class="categories-news-content">
              <el-form  :model="addForm" label-position="left" label-width="100px">
                ...
                <el-form-item label="更新平台:">
                  <el-radio v-model="addForm.pushsystem" label="1" class="countetps">iOS</el-radio>  <el-radio v-model="addForm.pushsystem" label="2" class="countetps">Android</el-radio>  
                </el-form-item>
                <el-form-item label="目标人群:">
                  <el-radio v-model="radio1" label="1" class="countetps">全部用户</el-radio>  
                </el-form-item>
        ...
        <div class="categories-news" v-if="this.addFormVisible">
            <div class="categories-news-main">
              <div class="categories-news-content">
                  ...
                  <el-table-column label="操作" width="180" fixed="right">
                    <template slot-scope="scope">
                        <el-button size="small" type="danger"
                                   @click="confirmAdd(scope.$index, scope.row)">选定</el-button>
                    </template>
                </el-table-column>
                </el-table>
              </div>
               <div class="categories-news-content">
                <el-button size="small" type="danger"
                                   @click="addFormVisible = false">取消</el-button>
              </div>
            </div>
        </div>
