      ...
      <div class="container">
        <div class="handle-box">
          ...
          <el-select v-model="addForm.examIspass" placeholder="选择考试结果状态" @change='changePass'>
            <el-option v-for="item in examIspass" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>
        ...
        <el-table :data="list" border stripe max-height="680" style="width: 100%" ref="multipleTable"
          ...
          <el-table-column prop="user_mobile" label="手机号" min-width="100" :show-overflow-tooltip="true">
          </el-table-column>
          <el-table-column prop="subject" label="证书类别/级别" min-width="100" :show-overflow-tooltip="true">
          </el-table-column>
          <el-table-column prop="study_time" label="学习时长(分)" min-width="100" :show-overflow-tooltip="true">
          </el-table-column>
          <el-table-column prop="exam_time" label="正式考试时间" min-width="100" :formatter="formatTime"
            :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="use_time" label="答题时长(分)" min-width="100" :formatter="formaExamtime"
            :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="is_pass" label="考试结果" min-width="100" :formatter="formatRecommend"
            :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="certification_status" label="证书发放状态" width="100" :formatter="formatType">
          </el-table-column>
          <el-table-column prop="certification_set_time" label="证书发放时间" width="100" :formatter="formatTime"
            :show-overflow-tooltip="true"></el-table-column>
          ...
          <div class="categories-news-main">
            ...
            <div class="categories-news-content">
              <el-form :model="addForm" label-position="left" label-width="120px">
                ...
                <el-form-item inline label="发放时间:" prop="certification_set_time" class="inline-block">
                  <div class="inline-block">
                    <span class="demonstration"></span>
                    <el-date-picker v-model="addForm.certification_set_time" type="date" placeholder="选择日期"
