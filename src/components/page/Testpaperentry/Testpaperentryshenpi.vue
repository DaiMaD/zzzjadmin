		...
		<div class="crumbs">
			...
			<div class="container">
				...
				<el-table :data="list" border stripe max-height="400" style="width: 100%" ref="multipleTable"
					...
					<el-table-column prop="certification_type" label="证书类型/级别" :formatter="formatType" width="150"
					...
					<el-table-column prop="status" label="状态" :formatter="formatStatus" :show-overflow-tooltip="true">
					</el-table-column>
					<el-table-column prop="create_time" label="创建时间" width="100" :formatter="formatTime"
						:show-overflow-tooltip="true"></el-table-column>
					<el-table-column prop="update_time" label="修改时间" width="100" :formatter="formatTime"
						:show-overflow-tooltip="true"></el-table-column>
							...
							<el-form :model="addForm" :rules="addFormRules" ref="addForm" label-position="left" label-width="120px">
								<el-form-item label="证书类型:" prop="certification_type">
									<el-select v-model="getZhengshuVal" placeholder="选择证书类型/级别" @change="changeType">
										<el-option v-for="item in getZhengshuData" :key="item.certification_type" :label="item.subject"
											:value="item.certification_type"></el-option>
									</el-select>
								</el-form-item>
