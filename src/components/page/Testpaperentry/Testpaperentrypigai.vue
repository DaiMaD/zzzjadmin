		...
		<div class="crumbs">
			...
			<div class="container">
				...
				<el-table :data="list" border max-height="400" style="width: 100%" ref="multipleTable"
					...
					<el-table-column prop="user_name" label="学员名称" min-width="100" :show-overflow-tooltip="true">
					</el-table-column>
					...
					<el-table-column prop="paper_status" label="批改状态" min-width="100" :formatter="formatStatus"
						:show-overflow-tooltip="true"></el-table-column>
					<el-table-column prop="check_person" label="批改人" min-width="100" :show-overflow-tooltip="true">
					</el-table-column>
					<el-table-column prop="exam_time" label="考试时间" min-width="100" :formatter="formatTime"
						:show-overflow-tooltip="true"></el-table-column>
					<el-table-column prop="check_time" label="批改时间" min-width="100" :formatter="formatTime"
						:show-overflow-tooltip="true"></el-table-column>
					<el-table-column prop="create_time" label="创建时间" min-width="100" :formatter="formatTime"
						:show-overflow-tooltip="true"></el-table-column>
						...
						<div class="categories-news-content">
							<el-form :model="addForm" label-position="left" label-width="120px">
								<div class="title_jj">
									<p class="shnehename">
										<span>批改人:</span>&nbsp;&nbsp;&nbsp;
										<el-input style="width:160px;" v-model="addForm1.checkperson" placeholder="请输入批改人姓名 "
											prop="peoples" />
