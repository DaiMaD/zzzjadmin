    ...
    <div class="crumbs">
      ...
      <div class="container">
        <div class="handle-box">
          <el-input style="width:180px" v-model="addForm.mobile" placeholder="手机号" ref='mobileInput'></el-input>
        ...
        <el-table :data="list" border stripe max-height="660" style="width: 100%;mso-number-format:'\@';"
          ref="multipleTable" :header-cell-style="{color:'#000',font_weight:800,background:'#ccc'}">
          ...
          <el-table-column prop="certification_type" label="证书类别/级别" :formatter="formatType"
            :show-overflow-tooltip="true" width="150"></el-table-column>
          <el-table-column prop="create_time" label="考试报名时间" :formatter="formatTime" :show-overflow-tooltip="true"
